...
*Document in English. Version francaise : [LIVRE-BLANC.md](./LIVRE-BLANC.md)*
...
Each developer runs the server locally. Zero infrastructure, zero cost.

### Team (shared server)

A KARUKIA server deployed on your infrastructure (Cloud Run, Kubernetes, VM) with:

- **Authentication** via bearer token (`MCP_API_KEY`)
- **Rate limiting** per session
- **Structured audit trail** (Pino JSON logs)
- **Custom checklists** possible

Contact **contact@karukia.com** for deployment support.
